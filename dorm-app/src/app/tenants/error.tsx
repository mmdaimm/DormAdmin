...
/**
 * Next.js App Router error boundary for /tenants.
 * Uses <a> hard-reload links per spec — no client-side router navigation.
 */
      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-900 border border-red-800/60 rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-sm text-red-300 text-center bg-red-950/40 border border-red-800/40 rounded-xl px-4 py-3 mb-6">
            เกิดข้อผิดพลาด: {error.message || 'ไม่สามารถโหลดหน้าจัดการผู้เช่าได้'}
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Hard-reload <a> tag as specified */}
            <a
              href="/"
